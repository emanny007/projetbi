      ...
      <div class="section__content section__content--p30">
          <div class="container-fluid">
            ...
            <div class="col-sm-6 col-lg-12">
                @include('includes.sous-menu-finelle')
          </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      <form action="{{ route('fine.performances.destroy', $performance->id) }}" method="post" onsubmit = 'ConfirmDelete()'><button class="btn btn-danger" type="submit">
            ...
            <div class="card">
              <div class="card-header">
               <strong></strong>
                    ...
                    <div class="card-body card-block">
                      <form name="form1" class="form-horizontal" method="POST" action="{{ route('fine.performances.store',$employe->id)}}">
                        {{ csrf_field() }}
                        <div class="row">
                      ...
                      <div class="form-group"> <center>
                        <a class="btn btn-xs btn-danger" href="{{ route('fine.performances.index') }}">RETOURNER</a>
