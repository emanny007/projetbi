          ...
          <div class="card">
            <div class="card-header">
             <strong></strong>
                  ...
                  <div class="card-body card-block">
                    <form name="form1" class="form-horizontal" method="POST" action="{{ route('fine.departs.update',$employe->id)}}">
                      {{ csrf_field() }}
                      <div class="row">
                    ...
                    <div class="form-group">
                      <center>
                        <a class="btn btn-xs btn-danger" href="{{ route('fine.departs.index') }}">RETOURNER</a>
