               ...
               <div class="card">
                   ...
                   <div class="card-body">
                       <div class="mx-auto d-block">
                           <img class="rounded-circle mx-auto d-block" src="/images/{{ $employe->photo }}" width="150" height="150">
                       ...
                       <!-- TOP CAMPAIGN-->
                                <div class="top-campaign">
                                    ...
                                    <center><br /><br />
                                      <a class="btn btn-xs btn-danger" href="{{ url('/finelle/employes') }}">RETOURNER</a>
                                    </center>
                                </div>
                                <!--  END TOP CAMPAIGN-->
