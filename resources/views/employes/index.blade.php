                        ...
                        <div id="#myTable">  </div>
                                        ...
                                        <a class="btn btn-xs btn-success" href="{{ route('create') }}"><span class="glyphicon glyphicon-eye-open"></span>Ajouter</a>
                                          ...
                                          <div class="table-responsive table m-b-40">
                                              <table class="table table-borderless table-striped table-earning" id="example" id="examplejj" class="display" data-order='[[ 1, "desc" ]]' data-page-length='50' style="width:100%">
                                                  <thead>
                                                      <tr>
                                                          <th>MATRICULE</th>
                                                          <th>NOM</th>
