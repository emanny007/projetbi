                                        ...
                                        <table class="table table-borderless table-earning">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Debut: {{ $experience->date_debut }}</td>
                                                    <td>Fin: {{ $experience->date_fin }}</td>
                                                    <td><form action="{{ route('experiences.destroy', $experience->id) }}" method="post" onsubmit = 'ConfirmDelete()'><button class="btn btn-danger" type="submit">
            ...
            <div class="card">
              <div class="card-header">
               <strong></strong>
                    ...
                    <div class="card-body card-block">
                      <form name="form1" class="form-horizontal" method="POST" action="{{ route('experiences.store',$employe->id)}}">
                        {{ csrf_field() }}
                        <div class="row">
