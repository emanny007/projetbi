    ...
    <div class="section__content section__content--p35">
        <div class="header3-wrap">
            <div class="header__logo">
                <a href="{{ url('/csg/accueil') }}"> <img src="{{ url('images/icon/logo.jpg') }}" alt="Groupe Cofina" width="200" height="75"/></a>
            </div>
            <div class="header__navbar">
                <ul class="list-unstyled">

                  <li>
                      <a href="{{ url('/csg/accueil') }}">
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="header3-sub-list list-unstyled">
                            <li>
                                <a href="{{ url('/csg/employes/create') }}"><i class="fas fa-folder-open"></i>Ajouter Employe</a>
                            </li>
                            <li>
                                <a href="{{ url('/csg/employes') }}"><i class="fas fa-folder-open"></i>Liste Employe</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="header3-sub-list list-unstyled">
                            <li>
                                <a href="{{ url('/csg/analyse/index') }}"><i class="fas fa-folder-open"></i>Departement</a>
                            </li>
                            <li>
                                <a href="{{ url('/csg/analyse/entite') }}"><i class="fas fa-folder-open"></i>Entite</a>
                            </li>
                            <li>
                                <a href="{{ url('/csg/analyse/contrat') }}"><i class="fas fa-folder-open"></i>Contrat</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="has-sub"><a href="{{ url('/csg/accueil') }}"> <img src="{{ url('images/drapeau/gabon.jpg') }}" alt="Groupe Cofina" width="50" height="50"/></a></li>
                </ul>
            </div>
