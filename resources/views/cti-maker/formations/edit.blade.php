...
@section('modify_formation_maker')
  <!-- MAIN CONTENT-->
  <div class="uker">
                                        ...
                                        <table class="table table-borderless table-earning">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Éts: {{ $formation->nbre_heure }}</td>
            ...
            <div class="card">
              <div class="card-header">
               <strong></strong>
                    ...
                    <div class="card-body card-block">
                      <form name="form1" class="form-horizontal" method="POST" action="{{ route('cti.formations.store',$employe->id)}}">
                        {{ csrf_field() }}
                        <div class="row">
