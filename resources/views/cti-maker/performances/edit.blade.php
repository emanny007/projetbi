                                        ...
                                        <table border="1" class="table table-borderless table-earning">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      <!--a class="btn btn-primary" href="{{ route('performances.modif',$employe->id) }}"><span class="fas fa-edit"></span></a-->
                                                      <form action="{{ route('cti.performances.destroy', $performance->id) }}" method="post" onsubmit = 'ConfirmDelete()'><button class="btn btn-danger" type="submit">
            ...
            <div class="card">
              <div class="card-header">
               <strong></strong>
                    ...
                    <div class="card-body card-block">
                      <form name="form1" class="form-horizontal" method="POST" action="{{ route('cti.performances.store',$employe->id)}}">
                        {{ csrf_field() }}
                        <div class="row">
                      ...
                      <div class="form-group"> <center>
                        <a class="btn btn-xs btn-danger" href="{{ route('cti.performances.index') }}">RETOURNER</a>
