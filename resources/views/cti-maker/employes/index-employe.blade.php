    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
          <div class="row m-t-30">
                                    ...
                                    @endif
                                        <a class="btn btn-xs btn-success" href="{{ route('cti.create-employe') }}"><span class="glyphicon glyphicon-eye-open"></span>Ajouter</a>
                                          <br /><br />
                                                  ...
                                                  <tbody>
                                                    @foreach ($employes as $employe)
                                                      <tr>
                                                          ...
                                                          <td align="center"><a class="btn btn-xs btn-info" href="{{ route('cti.show-employe',$employe->id) }}"><span class="fas fa-eye"></span></a>&nbsp;
                                                            <a class="btn btn-xs btn-primary" href="{{ route('cti.edit-employe',$employe->id) }}"><span class="fas fa-edit"></span></a>
                                                            <form action="{{ route('cti.destroy-employe', $employe->id) }}" method="post" onsubmit = 'ConfirmDelete()'>
