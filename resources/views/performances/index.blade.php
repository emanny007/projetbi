                              ...
                              <tr>
                                ...
                                <th>NOTE MDV EF</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td>{{ date('d-m-Y H:i:s', strtotime($performances->created_at)) }}</td>
                                      ...
                                      <td>{{ $performances->note_mdv_mp }}</td>
			                                ...
			                                @elseif($performances->position_ef=='PILIER +')
																			...
																			<td align="center"><a class="btn btn-xs btn-primary" href="{{ route('performances.edit',$performances->employe_id) }}"><span class="fas fa-edit"></span></a></td>
                                    </tr>
                                      @endforeach
                                    </tbody>
                          </table>
