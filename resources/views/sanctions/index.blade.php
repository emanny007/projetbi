                              ...
                              <tr>
                                ...
                                <th>TYPE DE SANCTION</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td>{{ date('d-m-Y H:i:s', strtotime($sanctions->created_at)) }}</td>
                                      <td>{{ $sanctions->prenom }} {{$sanctions->nom }}</td>
                                      <td>{{ $sanctions->type_sanction }}</td>
																			<td>{{ $sanctions->commentaire }}</td>
																			<td align="center"><a class="btn btn-xs btn-primary" href="{{ route('sanctions.edit',$sanctions->employe_id) }}"><span class="fas fa-edit"></span></a></td>
                                    </tr>
                                      @endforeach
                                    </tbody>
                          </table>
