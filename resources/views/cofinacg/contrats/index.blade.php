                                                    ...
                                                    @foreach ($employes as $employe)
                                                      <tr>
                                                        <td>{{ $employe->id }}</td>
                                                          ...
                                                          <td><a class="btn btn-xs btn-success" href="{{ route('cg.contrats.show',$employe->id) }}"><span class="fas fa-eye"></span></a>&nbsp;
                  <a class="btn btn-xs btn-danger" href="{{ route('cg.contrats.edit',$employe->id) }}"><span class="fas fa-edit"></span></a></td>
