           ...
           <div class="col-md-12">
               <div class="card">
                   ...
                   <div class="card-body">
                       ...
                       <center><a class="btn btn-xs btn-danger" href="{{ route('cg.contrats.index') }}">RETOURNER</a></center>
                    </div>
                   ...
                   <div class="card-body">
                       ...
                       <!-- TOP CAMPAIGN-->
                                <div class="top-campaign">
                                    ...
                                    <center><br /><br />
                                      <a class="btn btn-xs btn-danger" href="{{ url('/cofinacg/contrats/index') }}">RETOURNER</a>
                                    </center>
                                </div>
                                <!--  END TOP CAMPAIGN-->
                                @endif
