                              ...
                              <div class="col-md-12">
                                <div class="card">
                                  <div class="card-header">
                                   <center><strong>POSTE OCCUPE</strong></center>
                                  </div>
            ...
            <div class="card">
              <div class="card-header">
               <strong></strong>
                    ...
                    <div class="card-body card-block">
                      <form name="form1" class="form-horizontal" method="POST" action="{{ route('ci.postes.update',$employe->id)}}">
                        {{ csrf_field() }}
