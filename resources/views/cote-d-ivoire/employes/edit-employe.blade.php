...
@section('modify_employe_checker')
  <!-- MAIN CONTENT-->
  <div class="uker">
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                       <CENTER><strong>MODIFIER L'EMPLOYE</strong></CENTER>
                      </div>

                      <div class="card-body card-block">
                      <form  enctype="multipart/form-data" class="form-horizontal" method="POST" action="{{ route('update-employe',$employe->id)}}">
