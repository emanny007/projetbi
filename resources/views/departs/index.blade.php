                              ...
                              <tr>
                                ...
                                <th>DATE DEPART</th>
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td>{{ date('d-m-Y H:i:s', strtotime($departs->created_at)) }}</td>
                                      <td>{{ $departs->prenom }} {{$departs->nom }}</td>
                                      <td>{{ $departs->date_depart }}</td>
																			<td>{{ $departs->motif }}</td>
                                      <td>{{ $departs->statut }}</td>
																			<td align="center"><a class="btn btn-xs btn-primary" href="{{ route('departs.edit',$departs->employe_id) }}"><span class="fas fa-edit"></span></a></td>
                                    </tr>
                                      @endforeach
                                    </tbody>
                          </table>
