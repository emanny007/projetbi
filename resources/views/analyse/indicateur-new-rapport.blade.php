    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
          ...
          <div class="row m-t-30">
                <div class="col-md-12">
                  <div class="col-md-12">
                        <h4> TABLEAU DES INDICATEURS CLES DES FILIALES COFINA</h4>
                        <form action="{{ route('indicateur_new') }}" method="post" target="_blank">
                          {{csrf_field()}}
                          <input type="submit" name="export_pdf" value="Export PDF" class="btn btn-sm btn-success pull-right"/>
                        </form>

                      <form action="{{ route('analyse.indicateur-new') }}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <input type="submit" name="export_excel" value="Export Excel" class="btn btn-sm btn-primary pull-right"/>
                      </form>
                  </div>
                  <br /><br /><br />
                                  ...
                                  <tr>
                                    ...
                                    <td>AGE MOYEN</td>
                                      ...
                                      @foreach($age_employes_cac as $age_employes_cac)
                                        <td align='center'>{{$age_employes_cac->age_moyen }}</td>
                                      @endforeach
