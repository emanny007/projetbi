                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      <form action="{{ route('ml.performances.destroy', $performance->id) }}" method="post" onsubmit = 'ConfirmDelete()'><button class="btn btn-danger" type="submit">
            ...
            <div class="card">
              <div class="card-header">
               <strong></strong>
                    ...
                    <div class="card-body card-block">
                      <form name="form1" class="form-horizontal" method="POST" action="{{ route('ml.performances.store',$employe->id)}}">
                        {{ csrf_field() }}
                        <div class="row">
                      ...
                      <div class="form-group"> <center>
                        <a class="btn btn-xs btn-danger" href="{{ route('ml.performances.index') }}">RETOURNER</a>
