            ...
            <div class="row well m-t-30">
                  <div class="col-md-12">
                    <div class="card">
                      ...
                      <form  enctype="multipart/form-data" class="form-horizontal" method="POST" action="{{ route('gn.performances.update',$employe->id)}}">
                    ...
                    <div class="form-group"> <center>
                      <a class="btn btn-xs btn-danger" href="{{ route('gn.performances.edit',$employe->id) }}">RETOURNER</a>
