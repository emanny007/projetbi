...
class SanctionsnckController extends Controller
{
    /**
    ...
    {
      $sanctions=DB::select("select * from employes,sanctions where employes.id=sanctions.employe_id and employes.entite='COFINA SN'");
         return view('cofinasn-checker.sanctions.index', compact('sanctions'));
    }
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       return view('cofinasn-checker.sanctions.edit', compact('employe','sanctions'));
    }
