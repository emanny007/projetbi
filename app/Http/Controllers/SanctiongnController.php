...
class SanctiongnController extends Controller
{
    /**
    ...
    {
      $sanctions=DB::select("select * from employes,sanctions where employes.id=sanctions.employe_id and employes.entite='COFINA GN'");
         return view('cofinagn.sanctions.index', compact('sanctions'));
    }
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       return view('cofinagn.sanctions.edit', compact('employe','sanctions'));
    }
