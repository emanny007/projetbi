...
class PerformancecgController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      $performances=DB::select("select * from employes,performances where employes.id=performances.employe_id and employes.entite='COFINA CG' and employes.statut='ACTIVE'");

         return view('cofinacg.performances.index', compact('performances'));
    ...
    public function modif($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       ...
       return view('cofinacg.performances.modif', compact('employe','performance'));
    }
...
*/
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       ...
       return view('cofinacg.performances.edit', compact('employe','performance'));
    }
