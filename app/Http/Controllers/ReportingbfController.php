...
class ReportingbfController extends Controller
{
    /**
...
$rowArray = (array) $key;
  ...
  //dd($query);
      ...
      // $writer->save('hello wores.xlsx');
        ...
        return view('/cofinabf/reportings/index',['sites' => $sites,'departements' => $departements,'employes' => $employes,]);
    }
       ...
       public function export(Request $request)
       {
         ...
         return view('/cofinabf/reportings/index',[
         'sites' => $sites,
