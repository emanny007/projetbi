...
class Analyse_entitefineController extends Controller
{
  ...
  //************************************************
      ...
      return view('/finelle/analyse/entite',['employe' => $employes,'area' => $data,'data' => $area,'femmes' => $femmes,'hommes' => $hommes,
                  'chart' => $chart,
