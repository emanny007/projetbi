...
class PerformancectiController extends Controller
{
    /**
    ...
    {
      $performances=DB::select("select * from employes,performances where employes.id=performances.employe_id and employes.statut='ACTIVE'");

         return view('cti-maker.performances.index', compact('performances'));
    ...
    public function modif($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       ...
       return view('cti-maker.performances.modif', compact('employe','performance'));
    }
...
*/
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       ...
       return view('cti-maker.performances.edit', compact('employe','performance'));
    }
