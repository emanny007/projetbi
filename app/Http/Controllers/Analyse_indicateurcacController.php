...
class Analyse_indicateurcacController extends Controller
{
  ...
  public function indicateur(Request $request)
  {
    ...
    if(!empty($choisir_entite)){
      ...
      $hommes_cadres=DB::select("select count(*) as homme_cadre from employes, contrats where employes.id=contrats.employe_id AND employes.sexe='MASCULIN' AND employes.categorie='CADRE' AND employes.entite='$choisir_entite'");
      $hommes_noncadres=DB::select("select count(*) as homme_non_cadre from employes, contrats where employes.id=contrats.employe_id AND employes.sexe='MASCULIN' AND employes.categorie='NON CADRE' AND employes.entite='$choisir_entite'");
      $femmes_cadres=DB::select("select count(*) as femme_cadre from employes, contrats where employes.id=contrats.employe_id AND employes.sexe='FEMININ' AND employes.categorie='CADRE' AND employes.entite='$choisir_entite'");
      $femmes_noncadres=DB::select("select count(*) as femme_non_cadre from employes, contrats where employes.id=contrats.employe_id AND employes.sexe='FEMININ' AND employes.categorie='NON CADRE' AND employes.entite='$choisir_entite'");
      ...
      $employes=DB::select("select count(*) as total_empl from employes, contrats where employes.id=contrats.employe_id AND entite='$choisir_entite'");
      $hommes=DB::select("select count(*) as total_homme from employes, contrats where employes.id=contrats.employe_id AND employes.entite='$choisir_entite' AND employes.sexe='MASCULIN'");
      $femmes=DB::select("select count(*) as total_femme from employes, contrats where employes.id=contrats.employe_id AND employes.entite='$choisir_entite' AND employes.sexe='FEMININ'");
    ...
    if($choisir_entite=="ALL STAFF") {
      ...
      return view('/cac/analyse/indicateur',['employes' => $employes,'sites' => $sites,'choisir_entite' => $choisir_entite,
