...
class EmployemlController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      $employes=Employe::all()->where('entite','COFINA ML');

         return view('cofinaml.employes.index', compact('employes'));
    ...
    public function create()
    {
      ...
      $groupes= Groupe::orderby('id','asc')->paginate(20);
        return view('cofinaml.employes.create',[
          'sites' => $sites,
          'groupes' => $groupes,
    ...
    public function store(Request $request)
    {
      ...
      $request->validate([
       ...
       return redirect('/cofinaml/employes')->with('success', 'L\'employé a été ajouté avec succes !');
    ...
    public function show($id)
    {
      ...
      return view('cofinaml.employes.show',['employe' => $employes]);
    }
    ...
    public function edit($id)
    {
      ...
      $sites= Site::orderby('id','asc')->paginate(20);
      $groupes= Groupe::orderby('id','asc')->paginate(20);
        return view('cofinaml.employes.edit',[
          'employe' => $employe,
          'sites' => $sites,
          'groupes' => $groupes,
          'departements' => $departements,
    ...
    public function destroy($id)
    {
        $employe = Employe::findOrFail($id);
        $employe->delete();
        return redirect('/cofinaml/employes')->with('success', 'Employe deleted!');
    }
}
