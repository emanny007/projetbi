...
class ReportingfineController extends Controller
{
    /**
...
$rowArray = (array) $key;
  ...
  //dd($query);
      ...
      // $writer->save('hello wores.xlsx');
        ...
        return view('/finelle/reportings/index',['sites' => $sites,'departements' => $departements,'employes' => $employes,]);
    }
       ...
       public function export(Request $request)
       {
         ...
         return view('/finelle/reportings/index',[
         'sites' => $sites,
