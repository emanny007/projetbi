...
class EmployefineController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      $employes=Employe::all()->where('entite','FINELLE');

         return view('finelle.employes.index', compact('employes'));
    ...
    public function create()
    {
      ...
      $groupes= Groupe::orderby('id','asc')->paginate(20);
        ...
        return view('finelle.employes.create',[
          'sites' => $sites,
          'pays' => $pays,
          'groupes' => $groupes,
    ...
    public function show($id)
    {
      ...
      return view('finelle.employes.show',['employe' => $employes]);
    }
    ...
    public function edit($id)
    {
      ...
      $groupes= Groupe::orderby('id','asc')->paginate(20);
        ...
        return view('finelle.employes.edit',[
          'employe' => $employe,
          'sites' => $sites,
          'pays' => $pays,
          'groupes' => $groupes,
    ...
    public function destroy($id)
    {
        $employe = Employe::findOrFail($id);
        $employe->delete();
        return redirect('/finelle/employes')->with('success', 'Employe deleted!');
    }
}
