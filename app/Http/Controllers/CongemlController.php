...
class CongemlController extends Controller
{
  public function index()
  {
    //$conges=Conge::all();
    $conges=DB::select("select * from employes,conges where employes.id=conges.employe_id and employes.entite='COFINA ML'");
       return view('cofinaml.conges.index', compact('conges'));
  }
  ...
  public function edit($id)
  {
    ...
    $employe = Employe::findOrFail($id);
     return view('cofinaml.conges.edit', compact('employe','conge'));
  }
