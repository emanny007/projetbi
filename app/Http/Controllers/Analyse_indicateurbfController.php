...
class Analyse_indicateurbfController extends Controller
{
  ...
  public function indicateur(Request $request)
  {
    ...
    if($choisir_entite=="ALL STAFF") {
      ...
      return view('/cofinabf/analyse/indicateur',['employes' => $employes,'sites' => $sites,'choisir_entite' => $choisir_entite,
