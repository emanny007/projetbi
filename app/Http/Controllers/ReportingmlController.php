...
class ReportingmlController extends Controller
{
    /**
...
$rowArray = (array) $key;
  ...
  //dd($query);
      ...
      // $writer->save('hello wores.xlsx');
        ...
        return view('/cofinaml/reportings/index',['sites' => $sites,'departements' => $departements,'employes' => $employes,]);
    }
       ...
       public function export(Request $request)
       {
         ...
         return view('/cofinaml/reportings/index',[
         'sites' => $sites,
