...
class PerformancesnController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      $performances=DB::select("select * from employes,performances where employes.id=performances.employe_id and employes.entite='COFINA SN' and employes.statut='ACTIVE'");
         return view('cofinasn.performances.index', compact('performances'));
    ...
    public function modif($id)
    {
      ...
      $employe = Employe::findOrFail($id);
        ...
        //dd($performance);
       return view('cofinasn.performances.modif', compact('employe','performance'));
    }
...
*/
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       ...
       return view('cofinasn.performances.edit', compact('employe','performance'));
    }
