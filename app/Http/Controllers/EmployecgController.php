...
class EmployecgController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      $employes=Employe::all()->where('entite','COFINA CG');

         return view('cofinacg.employes.index', compact('employes'));
    ...
    public function create()
    {
      ...
      $groupes= Groupe::orderby('id','asc')->paginate(20);
        return view('cofinacg.employes.create',[
          'sites' => $sites,
          'groupes' => $groupes,
    ...
    public function store(Request $request)
    {
      ...
      $request->validate([
       ...
       return redirect('/cofinacg/employes')->with('success', 'L\'employé a été ajouté avec succes !');
    ...
    public function show($id)
    {
      ...
      return view('cofinacg.employes.show',['employe' => $employes]);
    }
    ...
    public function edit($id)
    {
      ...
      $sites= Site::orderby('id','asc')->paginate(20);
      $groupes= Groupe::orderby('id','asc')->paginate(20);
        return view('cofinacg.employes.edit',[
          'employe' => $employe,
          'sites' => $sites,
          'groupes' => $groupes,
          'departements' => $departements,
    ...
    public function destroy($id)
    {
        $employe = Employe::findOrFail($id);
        $employe->delete();
        return redirect('/cofinacg/employes')->with('success', 'Employe deleted!');
    }
}
