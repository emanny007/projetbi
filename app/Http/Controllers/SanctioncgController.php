...
class SanctioncgController extends Controller
{
    /**
    ...
    {
      $sanctions=DB::select("select * from employes,sanctions where employes.id=sanctions.employe_id and employes.entite='COFINA CG'");
         return view('cofinacg.sanctions.index', compact('sanctions'));
    }
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       return view('cofinacg.sanctions.edit', compact('employe','sanctions'));
    }
