...
class SanctionciController extends Controller
{
    /**
    ...
    {
      $sanctions=DB::select("select * from employes,sanctions where employes.id=sanctions.employe_id and employes.entite='CAC'");
         return view('cote-d-ivoire.sanctions.index', compact('sanctions'));
    }
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       return view('cote-d-ivoire.sanctions.edit', compact('employe','sanctions'));
    }
