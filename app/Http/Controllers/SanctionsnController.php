...
class SanctionsnController extends Controller
{
    /**
    ...
    public function index()
    {
      $sanctions=DB::select("select * from employes,sanctions where employes.id=sanctions.employe_id and employes.entite='COFINA SN'");
         return view('cofinasn.sanctions.index', compact('sanctions'));
    }
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       return view('cofinasn.sanctions.edit', compact('employe','sanctions'));
    }
