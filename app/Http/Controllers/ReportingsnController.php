...
class ReportingsnController extends Controller
{
    /**
...
$rowArray = (array) $key;
  ...
  //dd($query);
      ...
      // $writer->save('hello wores.xlsx');
        ...
        return view('/cofinasn/reportings/index',['sites' => $sites,'departements' => $departements,'employes' => $employes,]);
    }
       ...
       public function export(Request $request)
       {
         ...
         return view('/cofinasn/reportings/index',[
         'sites' => $sites,
