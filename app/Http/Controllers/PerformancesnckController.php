...
class PerformancesnckController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      $performances=DB::select("select * from employes,performances where employes.id=performances.employe_id and employes.entite='COFINA SN' and employes.statut='ACTIVE'");
         return view('cofinasn-checker.performances.index', compact('performances'));
    ...
    public function modif($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       ...
       return view('cofinasn-checker.performances.modif', compact('employe','performance'));
    }
...
*/
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       ...
       return view('cofinasn-checker.performances.edit', compact('employe','performance'));
    }
