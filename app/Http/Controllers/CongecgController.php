...
class CongecgController extends Controller
{
  public function index()
  {
    //$conges=Conge::all();
    $conges=DB::select("select * from employes,conges where employes.id=conges.employe_id and employes.entite='COFINA CG'");
       return view('cofinacg.conges.index', compact('conges'));
  }
  ...
  public function edit($id)
  {
    ...
    $employe = Employe::findOrFail($id);
     return view('cofinacg.conges.edit', compact('employe','conge'));
  }
