...
class PerformancemlController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      $performances=DB::select("select * from employes,performances where employes.id=performances.employe_id and employes.entite='COFINA ML' and employes.statut='ACTIVE'");
         return view('cofinaml.performances.index', compact('performances'));
    ...
    public function modif($id)
    {
      ...
      $employe = Employe::findOrFail($id);
        ...
        //dd($performance);
       return view('cofinaml.performances.modif', compact('employe','performance'));
    }
...
*/
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       ...
       return view('cofinaml.performances.edit', compact('employe','performance'));
    }
