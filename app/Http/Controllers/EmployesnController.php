...
class EmployesnController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      $employes=Employe::all()->where('entite','COFINA SN');
         ...
         return view('cofinasn.employes.index', compact('employes'));
    ...
    public function create()
    {
      ...
      $groupes= Groupe::orderby('id','asc')->paginate(20);
        ...
        return view('cofinasn.employes.create',[
          'sites' => $sites,
          'groupes' => $groupes,
    ...
    public function store(Request $request)
    {
      ...
      $request->validate([
       ...
       return redirect('/cofinasn/employes')->with('success', 'L\'employé a été ajouté avec succes !');
    ...
    public function show($id)
    {
      ...
      return view('cofinasn.employes.show',['employe' => $employes]);
    }
    ...
    public function edit($id)
    {
      ...
      $groupes= Groupe::orderby('id','asc')->paginate(20);
        ...
        return view('cofinasn.employes.edit',[
          'employe' => $employe,
          'sites' => $sites,
          'groupes' => $groupes,
          'departements' => $departements,
    ...
    public function destroy($id)
    {
        $employe = Employe::findOrFail($id);
        $employe->delete();
        return redirect('/cofinasn/employes')->with('success', 'Employe deleted!');
    }
}
