...
class SanctioncacController extends Controller
{
    /**
    ...
    public function index()
    {
      $sanctions=DB::select("select * from employes,sanctions where employes.id=sanctions.employe_id and employes.entite='CAC'");
         return view('cac.sanctions.index', compact('sanctions'));
    }
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       return view('cac.sanctions.edit', compact('employe','sanctions'));
    }
