...
class ContratfineController extends Controller
{
  ...
  public function edit($id)
  {
      ...
      $employe = Employe::findOrFail($id);
       return view('finelle.contrats.edit', compact('employe','contrat'));
  }
  ...
  public function update(Request $request, $id)
  {
          ...
          return redirect()->back()->with('status','Les informations du ce contrat ont bien été modifiées!');
  }
