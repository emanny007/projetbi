...
class SanctionctiController extends Controller
{
    /**
    ...
    public function index()
    {
      $sanctions=DB::select("select * from employes,sanctions where employes.id=sanctions.employe_id");
         return view('cti-maker.sanctions.index', compact('sanctions'));
    }
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       return view('cti-maker.sanctions.edit', compact('employe','sanctions'));
    }
