...
class PerformancegnController extends Controller
{
    /**
    ...
    public function index()
    {
      ...
      $performances=DB::select("select * from employes,performances where employes.id=performances.employe_id and employes.entite='COFINA GN' and employes.statut='ACTIVE'");
         return view('cofinagn.performances.index', compact('performances'));
    ...
    public function modif($id)
    {
      ...
      $employe = Employe::findOrFail($id);
        ...
        //dd($performance);
       return view('cofinagn.performances.modif', compact('employe','performance'));
    }
...
*/
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       ...
       return view('cofinagn.performances.edit', compact('employe','performance'));
    }
