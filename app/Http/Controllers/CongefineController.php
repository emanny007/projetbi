...
class CongefineController extends Controller
{
  public function index()
  {
    //$conges=Conge::all();
    $conges=DB::select("select * from employes,conges where employes.id=conges.employe_id and employes.entite='FINELLE'");
       return view('finelle.conges.index', compact('conges'));
  }
  ...
  public function edit($id)
  {
    ...
    $employe = Employe::findOrFail($id);
     return view('finelle.conges.edit', compact('employe','conge'));
  }
