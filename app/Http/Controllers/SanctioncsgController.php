...
class SanctioncsgController extends Controller
{
    /**
    ...
    {
      $sanctions=DB::select("select * from employes,sanctions where employes.id=sanctions.employe_id and employes.entite='CSG'");
         return view('csg.sanctions.index', compact('sanctions'));
    }
    ...
    public function edit($id)
    {
      ...
      $employe = Employe::findOrFail($id);
       return view('csg.sanctions.edit', compact('employe','sanctions'));
    }
